...
st.markdown("Directional Bias Checklist – Version 1.8")
...
# -----------------------
# Manual Wave Structure Overview
# -----------------------
st.subheader("Wave Structure Overview (Manual Override)")

st.markdown("""
You can manually tag higher timeframe wave context here for alignment.
""")
